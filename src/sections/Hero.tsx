  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute h-[444px] w-[444px] md:h-[700px] md:w-[700px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"
      ></motion.div>
      {/*end ring  2*/}
      {/*start ring 3 */}
      <motion.div
        ...
        className="absolute h-[544px] w-[544px] md:h-[980] md:w-[980] rounded-full border border-white opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"
      >
        <div className="absolute h-2 w-2  left-0 bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 "></div>
